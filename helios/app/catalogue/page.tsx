  ...
  return (
    <main className="bg-white p-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {i2.map((item) => {
            return <CatalogueItemComponent2 item={item} key={item.id.toString()}/>
        })}
...
function CatalogueItemComponent2({ item }: { item: CatalogueItem }) {
    return (
        <div className="rounded-2xl flex flex-col bg-gray-200">
            <Image
              src={'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/c6526d4b-644a-4242-b86f-d9e6e8eb83ea/challenger-dri-fit-13cm-brief-lined-running-shorts-57jvzH.png'}
          ...
          <div className='m-4 flex-col flex grow justify-between'>
            <div className="px-2 flex-row flex justify-between">
              ...
              <div className="w-2" />
              <h4 className="text-l text-black">
                ${item.price.toString()}
              </h4>
            </div>
            <div className="h-4" />
